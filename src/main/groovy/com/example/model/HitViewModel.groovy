...
class HitViewModel {
    ...
    HitViewModel(Map<String, Object> hit) {
        ...
        if (hit["type_is_audio"]) {
            this.type.push("Audio");
        }
        if (hit["type_is_video"]) {
            this.type.push("Video");
        }
        if (hit["type_is_emulated"]) {
            this.type.push("Emulated Formats");
        }
        if (hit["type_is_archive"]) {
            this.type.push("Archive");
        }
        if (hit["type_is_text"]) {
            this.type.push("Text Formats");
        }
        if (hit["type_is_executable"]) {
            this.type.push("Executable");
        }
        if (hit["type_is_apk"]) {
            this.type.push("APK");
        }
